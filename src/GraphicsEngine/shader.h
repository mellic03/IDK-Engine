...
enum ShaderType { SHADER_WORLDSPACE, SHADER_VIEWSPACE, SHADER_LIGHTSOURCE, SHADER_SHADOWMAP, SHADER_RENDERQUAD, SHADER_TEST, SHADER_POINTSHADOW, SHADER_SCREENQUAD };
