...
//     sprintf(buffer, "materials[%d].diffuseMap", i);
//     ren->active_shader.setInt(buffer, 0);

//     sprintf(buffer, "materials[%d].specularMap", i);
//     ren->active_shader.setInt(buffer, 1);

//     sprintf(buffer, "materials[%d].emissionMap", i);
//     ren->active_shader.setInt(buffer, 2);

//     sprintf(buffer, "materials[%d].normalMap", i);
//     ren->active_shader.setInt(buffer, 3);

//     sprintf(buffer, "materials[%d].spec_exponent", i);
//     ren->active_shader.setFloat(buffer, this->materials[i].spec_exponent);
